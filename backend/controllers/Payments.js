  ...
  for (const course_id of courses) {
    ...
    try {
      ...
      if (course.studentsEnrolled.includes(uid)) {
        ...
        return res
          .status(200)
          .json({ success: false, message: "Patient is already Enrolled" })
      }
...
exports.verifyPayment = async (req, res) => {
  ...
  if (expectedSignature === razorpay_signature) {
    await enrollPatients(courses, userId, res)
...
const enrollPatients = async (courses, userId, res) => {
  ...
  for (const courseId of courses) {
    try {
      ...
      console.log("Enrolled student: ", enrolledPatient)
