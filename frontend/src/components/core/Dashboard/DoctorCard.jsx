...
const DoctorCard = ({ fname, lname, docId }) => {
    ...
    return (
        <div className=" dark:bg-slate-800 gap-6 flex items-center justify-center  w-[500px] bg-yellow-50 mb-5 rounded-xl">
            <div
                ...
                <div className="flex items-center  gap-4  w-[500px] h-[200px]">
                    <img src="https://i.ibb.co/KwkvKnH/download-removebg-preview-2.png"
                    ...
                    <div className="w-fit transition-all transform duration-500">
                        ...
                        <a
                            className="text-xs text-gray-500 dark:text-gray-200  transform transition-all delay-300 duration-500">
