...
function SignupForm() {
  ...
  //   setFormData((prevData) => ({
  //     ...prevData,
  //     doctorDocument: e.target.files[0], // Store the uploaded file
  //   }));
  // };
  ...
  return (
    <div>
      ...
      <form onSubmit={handleOnSubmit} className="flex w-full flex-col gap-y-4">
        ...
        {/* New field for doctor's document */}
        {accountType === ACCOUNT_TYPE.DOCTOR && (
          <label className="w-full">
            <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5">
              Upload Document (Proof of Doctorate)
              <sup className="text-pink-200">*</sup>
            </p>
            <div className="relative bg-richblack-800 rounded-[0.5rem] p-[12px] text-richblack-5">
              <input
                type="file"
                name="doctorDocument"
